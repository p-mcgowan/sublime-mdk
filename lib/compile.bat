@"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\MSBuild\Current\Bin\Roslyn\csc.exe" ^
 ...
 /highentropyva+ ^
 /reference:c:\users\mcgow\appdata\local\microsoft\visualstudio\16.0_d66af101\extensions\u53jq2gv.kb1\MDKUtilities.dll ^
 /reference:"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\MSBuild\Microsoft\Microsoft.NET.Build.Extensions\net461\lib\Microsoft.Win32.Primitives.dll" ^
 ...
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.ComponentModel.Annotations.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.Reflection.Emit.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.Reflection.Emit.ILGeneration.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.Reflection.Emit.Lightweight.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.Runtime.InteropServices.WindowsRuntime.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.ServiceModel.Duplex.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.ServiceModel.Http.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.ServiceModel.NetTcp.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.ServiceModel.Primitives.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Facades\System.ServiceModel.Security.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\Microsoft.CSharp.dll" ^
 ...
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\System.Xml.dll" ^
 /reference:"C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1\System.Xml.Linq.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\Sandbox.Common.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\Sandbox.Game.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\Sandbox.Graphics.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\SpaceEngineers.Game.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\SpaceEngineers.ObjectBuilders.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\System.Collections.Immutable.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\VRage.Audio.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\VRage.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\VRage.Game.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\VRage.Input.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\VRage.Library.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\VRage.Math.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\VRage.Render.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\VRage.Render11.dll" ^
 /reference:"c:\program files (x86)\steam\SteamApps\common\SpaceEngineers\Bin64\VRage.Scripting.dll" ^
 /debug+ ^
 /debug:full ^
 /filealign:512 ^
 /ruleset:"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Team Tools\Static Analysis Tools\Rule Sets\MinimumRecommendedRules.ruleset" ^
 /subsystemversion:6.00 ^
 /target:exe ^
 /utf8output ^
 /langversion:6 ^
 /analyzer:c:\users\mcgow\appdata\local\microsoft\visualstudio\16.0_d66af101\extensions\u53jq2gv.kb1\Analyzers\MDKAnalyzer.dll ^
